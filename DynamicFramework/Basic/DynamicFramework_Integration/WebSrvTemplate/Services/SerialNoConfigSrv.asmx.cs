...
namespace DynamicWebSrv
{
    ...
    {	
        ...
        {
            return daoHelp.Select(o) as List<DynamicEntity.SerialNoConfigEntity>;
        }
        ...
        {
            return daoHelp.SelectsOrderBy(orderField, isDesc) as List<DynamicEntity.SerialNoConfigEntity>;
        }
    }
}
