...
namespace DynamicWebSrv
{
    ...
    {	
        ...
        {
            return AdjustAccountTableDao.Selects() as List<DynamicEntity.AdjustAccountTableEntity>;
        }
        ...
        {
            return AdjustAccountTableDao.Select(o) as List<DynamicEntity.AdjustAccountTableEntity>;
        }
        ...
        {
            return AdjustAccountTableDao.SelectsOrderBy(orderField, isDesc) as List<DynamicEntity.AdjustAccountTableEntity>;
        }
    }
}
