...
namespace DynamicWebSrv
{
    ...
    {	
        ...
        {
            return TableDicationaryDao.Selects() as List<DynamicEntity.TableDicationaryEntity>;
        }
        ...
        {
            return TableDicationaryDao.Select(o) as List<DynamicEntity.TableDicationaryEntity>;
        }
        ...
        {
            return TableDicationaryDao.SelectsOrderBy(orderField, isDesc) as List<DynamicEntity.TableDicationaryEntity>;
        }
    }
}
